...
const LEVELS: Level[] = [
  ...
  },
  {
    ...
    descriptions: [
      "O Querido Diário possui a fonte de publicação do diário oficial desta cidade, mas ainda não consegue coletar os arquivos. <a href='https://www.catarse.me/queridodiario-okbr' target='_blank'>Doe</a> e nos ajude a disponibilizar informações de mais cidades na plataforma.",
    ],
    texts: ['Acesse a fonte de publicação para ver os arquivos originais:'],
  },
  {
    icon: 'level-2',
